...
class CrossHyperspectralLidarAttention(nn.Module):
...
# Code for Single Encoder block contains both attention and mlp layer
class SingleEncoderBlock(nn.Module):
    def __init__(self,dim, num_heads, mlp_dim):
        ...
        self.cross_hl_attention = CrossHyperspectralLidarAttention(dim = dim, patches = 11**2) # Cross-HL Attention layer
